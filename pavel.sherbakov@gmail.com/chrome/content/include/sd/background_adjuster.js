  ...
  this._setupBg = function(){
    ...
    if( this.image ){
      ...
      if(this.imageLocationType === "parallax") {
        ...
        layer.style.backgroundImage = "url("+this.image.replace( "(", "\\(" ).replace( ")", "\\)" )+")";
