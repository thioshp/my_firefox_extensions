...
if (typeof(JSIO) != 'boolean') {
	...
	// Example use:
	// var fileIn = com.VidBar.FileIO.open('/test.txt');
	// if (fileIn.exists()) {
	// 	var fileOut = com.VidBar.FileIO.open('/copy of test.txt');
	// 	var str = com.VidBar.FileIO.read(fileIn);
	// 	var rv = com.VidBar.FileIO.write(fileOut, str);
	// 	alert('File write: ' + rv);
	// 	rv = com.VidBar.FileIO.write(fileOut, str, 'a');
	// 	alert('File append: ' + rv);
	// 	rv = com.VidBar.FileIO.unlink(fileOut);
	...
	com.VidBar.FileIO = {
		...
		create : function(file) {
			try {
				// changed to '0755' for Mac/Linux Version.
				var thisOS = com.VidBar.MainPref.getOSType();
				if ( thisOS == "Macintosh" ||
					 thisOS == "Linux" ||
					 thisOS == "Unix" )
					file.create(0x00, 0755);
				else
	...
	// Example use:
	// var dir = com.VidBar.DirIO.open('/test');
	// if (dir.exists()) {
	// 	alert(com.VidBar.DirIO.path(dir));
	// 	var arr = com.VidBar.DirIO.read(dir, true), i;
	// 	if (arr) {
	...
	// }
	// else {
	// 	var rv = com.VidBar.DirIO.create(dir);
	...
	com.VidBar.DirIO = {
		...
		open   : function(path) {
			return com.VidBar.FileIO.open(path);
		},
			...
			try {
				while (dirEntry.hasMoreElements()) {
					list.push(dirEntry.getNext()
									.QueryInterface(com.VidBar.FileIO.localfileIID));
				}
				if (recursive) {
					var list2 = new Array();
		...
		path   : function (dir) {
			return com.VidBar.FileIO.path(dir);
		},
